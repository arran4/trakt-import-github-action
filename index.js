...
// node_modules/trakt.tv/methods.json
var require_methods = __commonJS({
  "node_modules/trakt.tv/methods.json"(exports, module2) {
    module2.exports = {
      "/calendars/my/shows": {
        opts: {
          auth: true,
...
// node_modules/trakt.tv/package.json
var require_package = __commonJS({
  "node_modules/trakt.tv/package.json"(exports, module2) {
    module2.exports = {
      _from: "trakt.tv@^8.1.1",
      _id: "trakt.tv@8.1.1",
      _inBundle: false,
      _integrity: "sha512-gdRGixx16IIanzcEZWBnjLSw+8G7b6QQ9AIs1m4WH2I+93v28u6JaI1WmolVOUq8hIbhOUhkjy5qmV6Hi3/gYQ==",
      _location: "/trakt.tv",
      _phantomChildren: {},
      _requested: {
        type: "range",
      ...
      _resolved: "https://registry.npmjs.org/trakt.tv/-/trakt.tv-8.1.1.tgz",
      _shasum: "9ab84157c9204ddfd8311250321faf9784321e36",
      _spec: "trakt.tv@^8.1.1",
      _where: "/home/arran/GolandProjects/trakt-import-github-action",
      author: {
      ...
      homepage: "https://github.com/vankasteelj/trakt.tv#readme",
      keywords: [
        "trakt",
        "api",
        "wrapper",
      ...
      repository: {
        type: "git",
        url: "git+https://github.com/vankasteelj/trakt.tv.git"
      },
      scripts: {
...
var require_trakt = __commonJS({
  "node_modules/trakt.tv/trakt.js"(exports, module2) {
    "use strict";
    ...
    var defaultUa = `${pkg.name}/${pkg.version} (NodeJS; +${pkg.repository.url})`;
    module2.exports = class Trakt {
      constructor(settings = {}, debug) {
        if (!settings.client_id)
          throw Error("Missing client_id");
      ...
      _exchange(str) {
        ...
        return got(req).then((response) => {
          ...
          this._authentication.expires = (body.created_at + body.expires_in) * 1e3;
          return body;
        }).catch((error) => {
          ...
          if (pathParams[k][0] != ":") {
            ...
            if (param || param === 0) {
              ...
              if (method.optional && method.optional.indexOf(pathParams[k].substr(1)) === -1)
                throw Error(`Missing mandatory paramater: ${pathParams[k].substr(1)}`);
            }
          }
        }
      ...
      exchange_code(code, state) {
        if (state && state != this._authentication.state)
          throw Error("Invalid CSRF (State)");
      ...
      poll_access(poll) {
        ...
        return new Promise((resolve, reject) => {
          const call = () => {
            if (begin + poll.expires_in * 1e3 <= Date.now()) {
            ...
            this._device_code({
              ...
              this._authentication.refresh_token = body.refresh_token;
              this._authentication.access_token = body.access_token;
              this._authentication.expires = Date.now() + body.expires_in * 1e3;
              clearInterval(polling);
              resolve(body);
            }).catch((error) => {
